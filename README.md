# CareSmartz360 Design System (v3.5.0)
...
|--------|-------|------------------|------------|--------|-----------|------|
| **Agency Portal** | Web App | `Color Modes`, `Density Modes`, `General` | 280 vars across 3 collections (Color Modes 233 × 5 modes, Density Modes 31 × 1 mode, General 16 × 1 mode) | Active audit | `portals/agency/` | [C360-44253](https://netsmartz.atlassian.net/browse/C360-44253) |
