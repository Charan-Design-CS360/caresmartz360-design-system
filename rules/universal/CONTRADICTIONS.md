...
| C6 | **Provenance method for primitives** | `docs/VARIABLE-AUTHORITY-WORKFLOW.md` (pre-2026-09-14): "AI tools must not query Figma to infer or correct variable values" | `memory/primitives.md` cites "live-verified 2026-07-07 (live Figma + token export)" | ✅ RULED — **Singh 2026-09-14: read live Figma FIRST (it is the latest), owner exports second when Figma is unavailable; if both are available and disagree → HARD ALERT to Singh, never resolve silently (he re-exports). Fabricating/inferring values stays forbidden.** AI_CONTEXT.md + VARIABLE-AUTHORITY-WORKFLOW.md updated same day |
